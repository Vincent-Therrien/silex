...
slightly different computation time for each frame. And since double pendulums
are highly sensitive to small modifications, these little differences end up
